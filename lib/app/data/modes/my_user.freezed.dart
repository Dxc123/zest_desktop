...
class _$MyUserImpl with DiagnosticableTreeMixin implements _MyUser {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('userViewType', userViewType))
      ...
      ..add(DiagnosticsProperty('hireable', hireable))
      ..add(DiagnosticsProperty('bio', bio))
      ..add(DiagnosticsProperty('twitterUsername', twitterUsername))
      ..add(DiagnosticsProperty('publicRepos', publicRepos))
      ..add(DiagnosticsProperty('publicGists', publicGists))
...
abstract class _MyUser implements MyUser {
  const factory _MyUser(
      ...
      @JsonKey(name: 'hireable') final String? hireable,
      ...
      @JsonKey(name: 'updated_at') final String? updatedAt}) = _$MyUserImpl;
